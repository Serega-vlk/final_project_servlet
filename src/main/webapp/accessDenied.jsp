...
<html>
<head>
    <title><fmt:message key="deny.title" /></title>
    <a href="/user/logout">
...
<p style="text-align:center"><span style="font-size:26px"><span style="font-family:Comic Sans MS,cursive"><fmt:message key="deny.deny" /></span></span></p>
</body>
</html>
